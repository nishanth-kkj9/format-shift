...
export interface ImageConversionOptions {
  ...
  stripExif?: boolean; // Default true (canvas rasterization removes EXIF metadata)
}
...
export interface ConversionItem {
  ...
  lineCount?: number;
  statusMessage?: string; // e.g. "Processing image canvas...", "Encapsulating MP4 stream..."
}
