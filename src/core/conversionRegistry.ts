...
const IMAGE_TARGETS: Record<string, TargetSpec> = {
  jpg: { format: 'jpg', mime: 'image/jpeg', engine: 'browser', capabilities: { quality: true, resize: true, preview: true } },
  jpeg: { format: 'jpeg', mime: 'image/jpeg', engine: 'browser', capabilities: { quality: true, resize: true, preview: true } },
  png: { format: 'png', mime: 'image/png', engine: 'browser', capabilities: { quality: true, resize: true, preview: true } },
  webp: { format: 'webp', mime: 'image/webp', engine: 'browser', capabilities: { quality: true, resize: true, preview: true } },
  svg: { format: 'svg', mime: 'image/svg+xml', engine: 'browser', capabilities: { resize: true, preview: true } },
  ...
  ico: { format: 'ico', mime: 'image/x-icon', engine: 'server', capabilities: { resize: true, preview: true } },
  avif: { format: 'avif', mime: 'image/avif', engine: 'server', capabilities: { quality: true, resize: true, preview: true } },
};

const AUDIO_TARGETS: Record<string, TargetSpec> = {
  wav: { format: 'wav', mime: 'audio/wav', engine: 'browser', capabilities: { preview: true } },
  mp3: { format: 'mp3', mime: 'audio/mpeg', engine: 'server', capabilities: { quality: true, preview: true } },
  ...
  mp4: { format: 'mp4', mime: 'video/mp4', engine: 'browser', capabilities: { visualizer: true, preview: true } },
  webm: { format: 'webm', mime: 'video/webm', engine: 'browser', capabilities: { visualizer: true, preview: true } },
};
...
const VIDEO_TARGETS: Record<string, TargetSpec> = {
  ...
  webm: { format: 'webm', mime: 'video/webm', engine: 'server', capabilities: { resize: true, preview: true } },
  mov: { format: 'mov', mime: 'video/quicktime', engine: 'server', capabilities: { resize: true, preview: true } },
  mkv: { format: 'mkv', mime: 'video/x-matroska', engine: 'server', capabilities: { resize: true, preview: true } },
  avi: { format: 'avi', mime: 'video/x-msvideo', engine: 'server', capabilities: { resize: true, preview: true } },
  gif: { format: 'gif', mime: 'image/gif', engine: 'server', capabilities: { resize: true, preview: true } },
  // video -> audio extraction
  mp3: { format: 'mp3', mime: 'audio/mpeg', engine: 'server', capabilities: { audioExtract: true, quality: true, preview: true } },
  wav: { format: 'wav', mime: 'audio/wav', engine: 'server', capabilities: { audioExtract: true, preview: true } },
  ogg: { format: 'ogg', mime: 'audio/ogg', engine: 'server', capabilities: { audioExtract: true, quality: true, preview: true } },
  aac: { format: 'aac', mime: 'audio/aac', engine: 'server', capabilities: { audioExtract: true, quality: true, preview: true } },
  flac: { format: 'flac', mime: 'audio/flac', engine: 'server', capabilities: { audioExtract: true, preview: true } },
  m4a: { format: 'm4a', mime: 'audio/mp4', engine: 'server', capabilities: { audioExtract: true, quality: true, preview: true } },
};
...
const DATA_TARGETS: Record<string, TargetSpec> = {
  ...
  tsv: { format: 'tsv', mime: 'text/tab-separated-values', engine: 'browser', capabilities: { preview: true } },
