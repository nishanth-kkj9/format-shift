              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-2xl border border-white/10 bg-white/5 space-y-1">
                    ...
                    <p className="text-slate-300 leading-relaxed">Best for modern web performance. High compression with lossless alpha transparency and ultra-small file sizes.</p>
                  </div>
                  <div className="p-3.5 rounded-2xl border border-white/10 bg-white/5 space-y-1">
                    <span className="font-black text-indigo-400 block text-xs">.PNG</span>
                    <p className="text-slate-300 leading-relaxed">Best for graphics, logos, screenshots, and artwork requiring crisp lines and true transparent backgrounds.</p>
                  </div>
                  <div className="p-3.5 rounded-2xl border border-white/10 bg-white/5 space-y-1">
                    <span className="font-black text-amber-400 block text-xs">.JPG / .JPEG</span>
                    <p className="text-slate-300 leading-relaxed">Best for photography and real-world complex images where small file size is required.</p>
                  </div>
                  <div className="p-3.5 rounded-2xl border border-white/10 bg-white/5 space-y-1">
                    <span className="font-black text-emerald-400 block text-xs">.ICO / .SVG</span>
                    <p className="text-slate-300 leading-relaxed">.ICO is standard for web favicons (32x32px). .SVG is vector graphics scalable to any resolution without loss.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-2xl border border-white/10 bg-white/5 space-y-1">
                    ...
                    <p className="text-slate-300 leading-relaxed">Universal audio format supported on all devices, phones, and media players. Compact file size.</p>
                  </div>
                  <div className="p-3.5 rounded-2xl border border-white/10 bg-white/5 space-y-1">
                    <span className="font-black text-pink-400 block text-xs">.WAV</span>
                    <p className="text-slate-300 leading-relaxed">Uncompressed studio quality PCM audio. Ideal for audio editing, production, and high-fidelity sound.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-2xl border border-white/10 bg-white/5 space-y-1">
                    ...
                    <p className="text-slate-300 leading-relaxed">Convert tabular JSON arrays into CSV spreadsheets for Excel/Google Sheets, or vice versa.</p>
                  </div>
                  <div className="p-3.5 rounded-2xl border border-white/10 bg-white/5 space-y-1">
                    <span className="font-black text-teal-400 block text-xs">.YAML / .XML</span>
                    <p className="text-slate-300 leading-relaxed">Used for system configurations, web services, and enterprise data exchange formats.</p>
                  </div>
                </div>
              </div>
